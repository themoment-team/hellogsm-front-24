...
export const scoreFormSchema = z.object({
  score1_1: z.nullable(z.array(z.string().refine((value) => value && value !== DEFAULT_VALUE))),
  score1_2: z.nullable(z.array(z.string().refine((value) => value && value !== DEFAULT_VALUE))),
