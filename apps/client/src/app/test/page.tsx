...
const Test = async () => {
  ...
  const myOneseo: GetMyOneseoType = {
    ...
    middleSchoolAchievement: {
      achievement1_1: [4, 5, 3, 5, 4, 5, 3, 5, 1],
      achievement1_2: [4, 5, 3, 5, 4, 5, 3, 5, 1],
      achievement2_1: [4, 5, 3, 5, 4, 5, 3, 5, 1],
      achievement2_2: [4, 5, 3, 5, 4, 5, 3, 5, 1],
      achievement3_1: [4, 5, 3, 5, 4, 5, 3, 5, 1],
